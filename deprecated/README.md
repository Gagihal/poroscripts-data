...
This folder contains older versions of scripts that have been superseded by newer implementations.

## Files

### pokecreditor-mcmtcg-buttons.js (v0.2)
- **Replaced by:** `pokecreditor-mcmtcg-buttons.user.js` (v2.0)
