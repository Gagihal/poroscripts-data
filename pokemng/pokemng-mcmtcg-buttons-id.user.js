...
// @version      5.8
// @description  Adds MCM and TCG buttons using direct product ID links (fixed: treats "0" as invalid TCG ID). Automatic search skips NO CARD rows to find first valid card.
