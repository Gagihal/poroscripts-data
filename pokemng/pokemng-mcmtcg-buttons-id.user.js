...
// @version      5.4
// @description  Adds MCM and TCG buttons using direct product ID links with improved TCGplayer coverage. Automatic search skips NO CARD rows to find first valid card.
