// ==UserScript==
// @name         Pokemon Creditor list — tiny T/M buttons (EXAMPLE: Simplified with v1.4.0 utilities)
// @namespace    poroscripts
// @version      2.1-example
// @description  EXAMPLE: Shows how to use PoroSearch v1.4.0 button creation utilities
...
(async function () {
  ...
  async function enhance(){
    ...
    for (const row of rows){
      ...
      // Use the new utility to create both buttons at once!
